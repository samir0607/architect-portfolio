...
export default function Activity() {
  ...
  return (
    <div className="min-h-screen pb-6">
      ...
      <div className="bg-white/20 backdrop-blur-md border border-white/30 rounded-lg grid grid-cols-1 xl:grid-cols-[2fr_1fr] shadow-[0_0_15px_3px_rgba(0,215,180,0.7),0_0_40px_10px_rgba(0,123,128,0.4)] gap-8 max-w-7xl mx-auto p-6">
        ...
        <div className="flex items-center justify-center">
          <div className="w-full max-w-sm mx-auto">
            ...
            <div className="relative w-full aspect-[9/16] rounded-lg overflow-hidden border bg-black shadow-[0_0_15px_3px_rgba(0,115,200,0.7),0_0_40px_10px_rgba(0,123,228,0.4)]">
              {shorts.map((s, idx) => (
                <video
                  key={s.id}
