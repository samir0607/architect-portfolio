		...
		<div className="grid md:grid-cols-2 items-center gap-6 h-screen">
			<div className="md:w-[500px]">
				...
				<div className="mt-3 text-2xl">
					I'm 
					<TextType className="ml-3 w-[160px] bg-red-800 border rounded-xl shadow-[0_0_15px_3px_rgba(255,115,0,0.7),0_0_40px_10px_rgba(255,123,128,0.4)]" text={[" an Architect", " a Vlogger", " an Artist"]}/> 
				</div>
			...
			<div className="flex justify-center h-[400] md:h-[600]">
				<img src="profile.jpeg" alt="Loading..." className="rounded-2xl"/>
			</div>
		</div>
	</>
  );
