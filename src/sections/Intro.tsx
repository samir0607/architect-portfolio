		...
		<div className="grid md:grid-cols-2 items-center gap-6 h-screen">
			<div className="md:w-[500px]">
				...
				<div className="mt-3 text-2xl">
					I'm 
					<TextType className="ml-3 w-[160px] bg-yellow-600 border rounded-xl shadow-[0_0_15px_3px_rgba(255,215,0,0.7),0_0_40px_10px_rgba(255,223,128,0.4)]" text={[" an Architect", " a Vlogger", " an Artist"]}/> 
				</div>
			...
			<div className="flex justify-center">
				<img src="front.png" alt="Loading..." className=""/>
			</div>
		</div>
	</>
  );
