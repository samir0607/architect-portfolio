		...
		<div className="grid md:grid-cols-2 items-center gap-6 h-screen">
			<div className="md:w-[500px]">
				...
				<div className="mt-3 text-2xl">
					I'm 
					<TextType className="ml-3 w-[160px] border rounded-xl shadow-[0_0_15px_3px_rgba(0,115,180,0.7),0_0_40px_10px_rgba(0,223,128,0.4)]" text={[" an Architect", " a Vlogger", " an Artist"]}/> 
				</div>
